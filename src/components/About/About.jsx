    ...
    <div>
        ...
        <section className="process fadein-up">
            <div className="process__intro">
                <h6>3 steps for the perfect match</h6>
                <h2>Find Travel Perfection</h2>
                <p>Discover your ideal vacation with just a few clicks.</p>
            </div>
            <div className="process__icons">
                <div className="process__icons__step">
                    <img src={vectorIcon1} alt="vector icon 1"/>
                    <h5>Take The Questionnaire</h5>
                    <p>After a few questions about your travel preferences, we'll recommend cities or countries that match your preferences.</p>
                </div>
                <div className="process__icons__step">
                    <img src={vectorIcon2} alt="vector icon 2"/>
                    <h5>Find Your Destination</h5>
                    <p>Use our filters to narrow down destination options by location, type of trip, activities, and more. Swipe through tailored recommendations.</p>
                </div>
                <div className="process__icons__step">
                    <img src={vectorIcon3} alt="vector icon 3"/>
                    <h5>Start Planning</h5>
                    <p>Use our Trip Planner to create an itinerary that you can share with friends and family to help you plan your perfect vacation.</p>
                </div>
            </div>
        </section>
