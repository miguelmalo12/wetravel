    ...
    return (
        <div className={`hero-form-input__group-container ${isFocused ? 'focused' : ''}`}>
            ...
            <div className="hero-form-input__group">
                ...
                <select onChange={onChange} type="text" name={name} className={`hero-form-input__input hero-form-input__input--select`} onFocus={handleFocus} onBlur={handleBlur}>
        ...
        <div className="hero-form-input__wrapper hero-form-input__wrapper--simple">
            <div className={`hero-form-input__group-container hero-form-input__group-container--double ${isFocused1 ? 'focused' : ''}`}>
                ...
                <div className="hero-form-input__group">
                    ...
                    <select onChange={onChange} name={name1} type="text" className="hero-form-input__input hero-form-input__input--select" onFocus={handleFocus1} onBlur={handleBlur1}>
            ...
            <div className={`hero-form-input__group-container hero-form-input__group-container--double ${isFocused2 ? 'focused' : ''}`}>
                ...
                <div className="hero-form-input__group">
                    ...
                    <select onChange={onChange} name={name2} type="text" className="hero-form-input__input hero-form-input__input--select" onFocus={handleFocus2} onBlur={handleBlur2}>
